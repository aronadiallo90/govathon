...
(1, 'Présélection', 'Première phase de sélection des projets', 2, '2024-05-01', '2024-05-15', '2025-05-05 12:50:47', '2025-05-19 10:39:43', 'en_cours'),
(2, 'Qualification', 'Phase de qualification des projets retenus', 3, '2024-05-16', '2024-05-31', '2025-05-05 12:50:47', '2025-05-19 10:31:21', 'a_venir'),
(4, 'Finale', 'Phase finale du concours', 4, '2024-06-16', '2024-06-30', '2025-05-05 12:50:47', '2025-05-19 10:31:10', 'a_venir'),
(8, 'Inscription', 'les equipes s\'inscrivent', 1, '2025-05-16', '2025-05-16', '2025-05-15 09:19:33', '2025-05-19 10:39:36', 'terminee');
...
--
-- Déchargement des données de la table `project_etapes`
--
...
--
-- Index pour la table `project_etapes`
--
...
ALTER TABLE `votes`
  ...
  ADD KEY `idx_votes_etape` (`etape_id`),
  ADD KEY `idx_votes_project` (`project_id`);
...
--
-- Contraintes pour la table `project_etapes`
--
ALTER TABLE `project_etapes`
  ADD CONSTRAINT `project_etapes_ibfk_1` FOREIGN KEY (`project_id`) REFERENCES `projects` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `project_etapes_ibfk_2` FOREIGN KEY (`etape_id`) REFERENCES `etapes` (`id`) ON DELETE CASCADE;
